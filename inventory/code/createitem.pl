...
print "<h1>ISIP Inventory: Create New Item...</h1>\n";
...
print "<tr><td bgcolor='white'><input type='radio' name='createaction' value='A'> I have a photo folder on my computer and will copy it to the shared network drive. (A new item will be created automatically.) </td></tr>";
print "<tr><td bgcolor='#d1e8f9'><input type='radio' name='createaction' value='B'> I want to create a new empty item now! (You can upload photos later.) </td></tr>";
print "<tr><td bgcolor='white'><input type='radio' name='createaction' value='C'> I want to create a new item and copy the photos from $actionCComboboxAllItems! </td></tr>";
